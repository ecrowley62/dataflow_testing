# Auth: Eric Crowley
# Date: 2019-11-26
# Desc: ETL pipelin written using beam for INTTRA sibklink data set
...
google_cloud_options.job_name = f"clean-intra-sibklink-{datetime.now().strftime('%Y%m%d%H%M%S')}"
