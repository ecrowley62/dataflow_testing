# Auth: Eric Crowley
# Date: 2019-11-26
# Desc: Cleaning pipelin written using beam for INTTRA bktp data set
...
google_cloud_options.job_name = f"clean-intra-bktp-{datetime.now().strftime('%Y%m%d%H%M%S')}"
